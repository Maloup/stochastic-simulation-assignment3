...
def simulated_annealing(s0, t, P, y0=None,
    ...
    state = s0
    state_cost = int_cost_lotka_volterra(state, P, t, cost=cost, y0=y0)
    costs = []
    ...
    for T in T_sched:
        ...
        new_state_cost = int_cost_lotka_volterra(state_new, P, t, cost=cost, y0=y0)
